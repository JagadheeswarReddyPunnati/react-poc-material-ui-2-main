      ...
      <main className=" container-fluid hide-on-print" id="main-body">
        <div className="row">
          <div className="col-md-3">
            <PanelComponent heading="Welcome to IFMIS" body="Dear User" className="panel-success col-md-12">
          ...
          <div className="col-md-6">
            <PanelComponent heading="MaryLand StateStat" description={panelDescription} className="panel-success col-md-12">
              <Switch>
